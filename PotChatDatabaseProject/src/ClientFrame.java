...
public class ClientFrame extends javax.swing.JFrame 
{
    ...
    String username, address = "localhost", userName, pass;
    ...
    */
    ...
    public ClientFrame(int port_no, String username, String password) 
    {
        initComponents();
        port = port_no;
        userName = username;
    ...
    public void connectAuto2(){
        if (isConnected == false) 
        {
            ...
            try 
            {
                ...
                reader = new BufferedReader(streamreader);
                writer = new PrintWriter(sock.getOutputStream());
                writer.println(username+":"+pass+":Authentication");
                writer.flush();
                writer.println(username + ":has connected.:Connect");
                writer.flush();
    ...
    */
    ...
    public void dataToServer(String s, String s2){
        
        writer.println(username+":"+s+":"+s2);
